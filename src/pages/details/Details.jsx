            ...
            <div className='col-span-1'>
                ...
                <div>
                    ...
                    <div className='flex items-center gap-4 my-5'>
                        <div>
                            <img className='w-32' src="/assets/latesImg/oyakodon-japanese-chicken-and-egg-rice-bowl-recipe-hero-f2d42cfe8e8e4436b97d6e79d038d9bc.jpeg" alt="" />
                        </div>
                        <div>
                    ...
                    <div className='flex items-center gap-4 my-5'>
                        <div>
                            <img className='w-32' src="/assets/latesImg/easy-dinner-recipes-pizza-casserole-1676054902.jpeg" alt="" />
                        </div>
                        <div>
                            <h2 className='text-xl font-semibold'>Recipe Title Here</h2>
                            <p>heap into electronic type setting</p>
                    ...
                    <div className='flex items-center gap-4 my-5'>
                        <div>
                            <img className='w-32' src="/assets/site-img/DetailsBanner.jpg" alt="" />
                        </div>
                        <div>
                            <h2 className='text-xl font-semibold'>Recipe Title Here</h2>
                            <p>heap into electronic type setting</p>
                    ...
                    <div className='flex items-center gap-4 my-5'>
                        <div>
                            <img className='w-32' src="/assets/latesImg/fruit-custard-recipe.jpg" alt="" />
                        </div>
                        <div>
                            <h2 className='text-xl font-semibold'>Recipe Title Here</h2>
                            <p>heap into electronic type setting</p>
                    ...
                    <div className='flex items-center gap-4 my-5'>
                        <div>
                            <img className='w-32' src="/assets/latesImg/basic-congee-recipes-4065244-hero-01-5cf81547c34d4520be10bb57c6cda902.jpg" alt="" />
                        </div>
                        <div>
                            <h2 className='text-xl font-semibold'>Recipe Title Here</h2>
                            <p>heap into electronic type setting</p>
                ...
                <div>
                    <img src="/assets/latesImg/06_recipe_details (2).jpg" alt="" />
                </div>
            </div>
            <ToastContainer />
        </div>
